module plfa.lf.Connectives where
...
open import plfa.lf.Isomorphism using (_≃_; _≲_; extensionality; _⇔_)
open plfa.lf.Isomorphism.≃-Reasoning
...
--- Conjunction is product (in set theory, called Cartesian product)
data Bool : Set where
  true  : Bool
  false : Bool
